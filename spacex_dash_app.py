...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values = filtered_df['class'].value_counts().values, names = filtered_df['class'].value_counts().index, title=f'Success vs. Failure for {entered_site}')
        return fig
